...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Styles: Custom minimalis dan glassmorphism -->
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
        <style>
            body {
                font-family: 'Inter', sans-serif;
                background: linear-gradient(120deg, #f8ede3 0%, #f7d9c4 100%);
            }
            .glass {
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-4">
                    <div class="flex items-center gap-4">
                        <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-12 w-auto bg-gray-100 rounded-lg shadow">
                        ...
                        <span class="ml-2 text-2xl font-semibold tracking-wide text-[#b87d5a]">Verse Beauty</span>
                    </div>
                    <form class="flex items-center w-full max-w-md md:ml-8" action="#" method="GET">
                        <input type="text" name="search" class="w-full px-4 py-2 border border-[#e5cfc0] rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#b87d5a] bg-[#f8ede3] placeholder-[#b87d5a]" placeholder="Cari produk, brand, makeup...">
                        <button type="submit" class="px-4 py-2 bg-[#b87d5a] text-white rounded-r-lg hover:bg-[#a06c4e]">Cari</button>
                    </form>
                </div>

                <!-- Banner Diskon Estetik -->
                <div class="w-full mb-10">
                    <div class="glass flex flex-col md:flex-row items-center justify-between px-8 py-8 gap-6 relative overflow-hidden">
                        <div>
                            <div class="banner-title mb-2">Ekstra Diskon 15% untuk Produk Makeup</div>
                            <div class="banner-desc">Hanya hari ini! Temukan produk favoritmu dengan harga spesial.</div>
                        </div>
                        <div class="hidden md:block absolute right-0 bottom-0 h-full opacity-20">
                            <img src="https://cdn-icons-png.flaticon.com/512/2921/2921823.png" alt="Makeup Banner" class="h-32 mr-8 mb-2">
                        </div>
                    </div>
                </div>
